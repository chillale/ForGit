...
public class ProduceMod1Test {
	@Test(groups = "integration")
	public void produc() throws Throwable {
		...
		productDetailsPage.getProductNameTf().sendKeys(excelUtility.readDataFromExcel("sheet1", 3, 0)+j.generateRandom());
